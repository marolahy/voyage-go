...
import com.bezama.voyage.security.OAuth2PrincipalExtractor
import com.bezama.voyage.security.OAuth2SsoAuthenticationSuccessHandler
import com.bezama.voyage.service.UtilisateurService
...
class WebSecurityConfiguration(private val oauth2ClientContext: OAuth2ClientContext,
                               ...
                               private val accountService: UtilisateurService) : WebSecurityConfigurerAdapter() {
